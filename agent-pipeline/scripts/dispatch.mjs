...
try {
  ...
  if (owed != null) {
    throw new Error(
      `Phase ${record.pipeline_state?.phase} belongs to the orchestrator, which transitions then dispatches. ` +
        `Move it, commit the store, then dispatch: node agent-pipeline/scripts/transition.mjs ${issueId} ${role}`,
    );
  }
