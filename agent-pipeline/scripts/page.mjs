...
.facts{margin:0;padding:0;display:flex;flex-direction:column;gap:.75rem}
.facts>div{display:grid;grid-template-columns:minmax(10rem,14rem) minmax(0,1fr);gap:1.5rem;align-items:start}
.facts dt{font-family:var(--mono);font-size:.72rem;line-height:1.5;color:var(--faint)}
 ...
 * @param head - trusted metadata generated by a renderer
 * @returns the complete page, with no external resource to load
 */
export function shell(title, body, head = "") {
  return `<!doctype html>
<html>
<head>
<meta charset="utf-8">
